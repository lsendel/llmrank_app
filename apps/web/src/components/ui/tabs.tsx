...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 w-full max-w-full items-center justify-start overflow-x-auto rounded-[var(--radius-md)] border border-border/70 bg-muted/60 p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
